...
1. **Mes vêtements** — chaque pièce a un type, une couleur, une marque, une
   ...
   Les **parfums** ont en plus un moment : journée ou soirée (un citrus l’été
   en journée, un oriental l’été en soirée). En ajoutant une pièce, tu peux
   coller le lien d’un article : nom, photo, type, marque et couleur se
   préremplissent.
