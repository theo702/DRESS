...
export function AtelierScreen() {
  const { garments, saveOutfit } = useStore()
  ...
  function onSave() {
    ...
    setSavedFlash('Tenue enregistrée.')
    setName('')
  }
    ...
    <div className="space-y-4">
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-muted">Clique une pièce pour l’assembler. Le score se recalcule à chaque geste.</p>
        </div>
